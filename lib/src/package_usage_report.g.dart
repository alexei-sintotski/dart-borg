...
part of 'package_usage_report.dart';

// **************************************************************************
// FunctionalDataGenerator
// **************************************************************************

abstract class $PackageUsageReport {
  dynamic get dependencyName;
  Map<PackageDependency, List> get references;
  const $PackageUsageReport();
  PackageUsageReport copyWith({dynamic dependencyName, Map<PackageDependency, List> references}) => PackageUsageReport(
      dependencyName: dependencyName ?? this.dependencyName, references: references ?? this.references);
  String toString() => "PackageUsageReport(dependencyName: $dependencyName, references: $references)";
...
class PackageUsageReport$ {
  static final dependencyName = Lens<PackageUsageReport, dynamic>(
      (s_) => s_.dependencyName, (s_, dependencyName) => s_.copyWith(dependencyName: dependencyName));
  static final references = Lens<PackageUsageReport, Map<PackageDependency, List>>(
